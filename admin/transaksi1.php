...
<body>
    ...
    <div class="title">
        ...
        <p>Riwayat transaksi akan ditampilkan berdasarkan transaksi terbaru yang telah terverifikasi</p>
    </div>
    ...
    <div class="home-content">
        ...
        <table>
            ...
            <tbody>
                ...
                $query = "SELECT * FROM data_transaksi JOIN data_produk ON data_transaksi.id_produk = data_produk.id_produk JOIN data_user ON data_transaksi.id_pembeli = data_user.id WHERE data_transaksi.status = 'Riwayat'";
            ...
            <tfoot>
                <tr>
                    <td colspan="8"><a href="transaksi.php"><button type="button" id="tambah" style="cursor: pointer;">Sedang Berlangsung</button></a></td>
                </tr>
            </tfoot>
        </table>
        <!-- Akhir tabel -->
